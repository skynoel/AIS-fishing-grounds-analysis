...
root = tk.Tk()
root.title("TOMK AIS Tool v1.2.1")
...
execute_button.pack()
sp2_var = tk.StringVar(root)
sp2_frame = tk.Frame(root)

sp2_frame.pack()
sp2_label = tk.Label(sp2_frame, text=" ")
sp2_label.pack()
sp3_label = tk.Label(sp2_frame, text=" ")
sp3_label.pack()
...
end_frame.pack()
end_label = tk.Label(end_frame, text="Copyright © Skynoel 2024" , fg="gray", font=("Helvetica", 25))
end_label.pack()
end_label2 = tk.Label(end_frame, text="made at 2024/08/07" , fg="gray", font=("Helvetica", 20))
end_label2.pack()
